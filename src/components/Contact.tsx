...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-stone-50">
      ...
      <div className="absolute top-[32%] left-[11%] w-4 h-4 rounded-full bg-teal-900 animate-float opacity-35" style={{
      animationDelay: "1s"
    }}></div>
      <div className="absolute top-[52%] right-[14%] w-3 h-3 rounded-full bg-teal-900 animate-pulse opacity-50" style={{
      animationDelay: "1.5s"
    }}></div>
      <div className="absolute bottom-[16%] left-[8%] w-2 h-2 rounded-full bg-teal-900 animate-float opacity-45" style={{
      animationDelay: "2s"
    }}></div>
      <div className="absolute bottom-[26%] right-[11%] w-5 h-5 rounded-full bg-teal-900 animate-pulse opacity-40" style={{
      animationDelay: "2.5s"
    }}></div>
      
      {/* Small rotating circles - updated to teal-900 */}
      <div className="absolute top-[18%] left-[16%] w-6 h-6 rounded-full border border-teal-900 animate-spin-slow opacity-45"></div>
      <div className="absolute top-[38%] right-[19%] w-4 h-4 rounded-full border border-teal-900 animate-spin-slow opacity-40" style={{
      animationDirection: "reverse"
    }}></div>
      <div className="absolute bottom-[20%] left-[19%] w-5 h-5 rounded-full border border-teal-900 animate-spin-slow opacity-50" style={{
      animationDelay: "1s"
    }}></div>
      <div className="absolute bottom-[40%] right-[24%] w-3 h-3 rounded-full border border-teal-900 animate-spin-slow opacity-45" style={{
      animationDirection: "reverse",
      animationDelay: "1.5s"
    }}></div>
      
      {/* Additional floating bubbles - updated to teal-900 */}
      <div className="absolute top-[58%] left-[4%] w-2 h-2 rounded-full bg-teal-900 animate-pulse opacity-40" style={{
      animationDelay: "3s"
    }}></div>
      <div className="absolute top-[68%] right-[5%] w-3 h-3 rounded-full bg-teal-900 animate-float opacity-35" style={{
      animationDelay: "3.5s"
    }}></div>
      <div className="absolute top-[7%] left-[32%] w-2 h-2 rounded-full bg-teal-900 animate-pulse opacity-45" style={{
      animationDelay: "4s"
    }}></div>
      <div className="absolute bottom-[7%] right-[32%] w-4 h-4 rounded-full bg-teal-900 animate-float opacity-40" style={{
      animationDelay: "4.5s"
    }}></div>
      
      {/* New warm brown animated elements - FORCED FULL OPACITY */}
      {/* Floating hexagon near title */}
      <div className="absolute top-[25%] left-[35%] w-6 h-6 bg-amber-800 animate-spin-slow !opacity-100 z-0" style={{
        clipPath: "polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)",
        animationDelay: "1.2s"
      }}></div>
      
      {/* Floating diamond near contact cards */}
      <div className="absolute bottom-[35%] right-[5%] w-5 h-5 bg-amber-800 animate-pulse !opacity-100 transform rotate-45 z-0" style={{
        animationDelay: "2.8s"
      }}></div>
      
      {/* Pulsing plus sign - FORCED FULL OPACITY */}
      <div className="absolute top-[45%] left-[3%] animate-pulse !opacity-100 z-0" style={{
        animationDelay: "3.4s"
      }}>
        <div className="w-1.5 h-6 bg-amber-800 absolute"></div>
        <div className="w-6 h-1.5 bg-amber-800 absolute top-2.5 -left-2.5"></div>
      </div>
      
      {/* Floating triangle near contact cards */}
      <div className="absolute bottom-[50%] right-[30%] w-0 h-0 animate-float !opacity-100 z-0" style={{
      ...
      {/* Spinning gear */}
      <div className="absolute top-[65%] left-[25%] w-6 h-6 bg-amber-800 animate-spin-slow !opacity-100 z-0" style={{
        clipPath: "polygon(50% 0%, 60% 40%, 100% 50%, 60% 60%, 50% 100%, 40% 60%, 0% 50%, 40% 40%)",
        animationDelay: "4.2s"
      }}></div>
      
      {/* Floating star near header */}
      <div className="absolute top-[22%] right-[25%] w-6 h-6 bg-amber-800 animate-float !opacity-100 z-0" style={{
      ...
      {/* Lightning bolt */}
      <div className="absolute top-[55%] right-[8%] w-5 h-8 bg-amber-800 animate-pulse !opacity-100 z-0" style={{
        clipPath: "polygon(20% 0%, 80% 0%, 60% 40%, 100% 40%, 40% 100%, 0% 60%, 40% 60%)",
        animationDelay: "3.9s"
      }}></div>
      
      {/* Heart shape */}
      <div className="absolute bottom-[60%] left-[40%] w-6 h-6 bg-amber-800 animate-pulse !opacity-100 z-0" style={{
      ...
      <div className="container relative z-10 py-16 md:py-24 bg-transparent">
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full text-teal-900 font-medium mb-6 border border-teal-900 bg-transparent">
            <Heart className="h-4 w-4 mr-2 text-teal-900" />
            <span className="text-teal-900">Let's chat!</span>
          </div>
        ...
        <div className="flex justify-center">
          <div className="space-y-8 max-w-3xl w-full">
            <div className="group relative">
              ...
              <div className="absolute inset-0 bg-teal-900 opacity-0 group-hover:opacity-70 blur-xl transition-all duration-300 rounded-xl -z-10"></div>
              ...
              <div className="backdrop-blur-sm p-8 rounded-2xl border border-primary/10 shadow-lg card-hover text-center bg-white">
                <div className="flex flex-col items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:basselatout@icloud.com" className="text-teal-900 hover:underline inline-flex items-center group justify-center">
