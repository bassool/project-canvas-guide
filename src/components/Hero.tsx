  ...
  return <section id="home" className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-stone-50">
      ...
      <div className="container grid gap-8 lg:grid-cols-2 lg:gap-12 items-center relative z-10">
        <div className="space-y-8 animate-fade-in">
          ...
          <p className="text-lg sm:text-xl max-w-md text-gray-600">Creative Project/Product Manager turning imaginative ideas into extraordinary realities that captivate and inspire.</p>
        ...
        <div className="relative aspect-square animate-float">
          ...
          <div className="relative z-10 overflow-hidden rounded-2xl shadow-lg aspect-square border border-gray-200">
            <img alt="Creative director at work" src="/lovable-uploads/7bd59ef7-5dc0-4d32-a198-2ee8f8ce46e4.png" className="w-full h-full  object-cover" />
          </div>
