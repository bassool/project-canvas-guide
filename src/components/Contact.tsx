...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-amber-50">
      ...
      <div className="absolute top-[25%] left-[35%] w-6 h-6 bg-violet-600 animate-spin-slow opacity-25 z-0"
           style={{
      ...
      <div className="absolute bottom-[35%] right-[5%] w-5 h-5 bg-violet-600 animate-pulse opacity-20 transform rotate-45 z-0" 
           style={{
             animationDelay: "2.8s"
           }}></div>
      
      {/* Pulsing plus sign */}
      <div className="absolute top-[45%] left-[3%] animate-pulse opacity-20 z-0"
           style={{
             animationDelay: "3.4s"
           }}>
      ...
      <div className="absolute bottom-[50%] right-[30%] w-0 h-0 animate-float opacity-25 z-0"
           style={{
      ...
      {/* Spinning gear */}
      <div className="absolute top-[65%] left-[25%] w-6 h-6 bg-violet-600 animate-spin-slow opacity-20 z-0"
           style={{
      ...
      <div className="absolute top-[22%] right-[25%] w-6 h-6 bg-violet-600 animate-float opacity-30 z-0" 
           style={{
      ...
      {/* Lightning bolt */}
      <div className="absolute top-[55%] right-[8%] w-5 h-8 bg-violet-600 animate-pulse opacity-25 z-0"
           style={{
      ...
      {/* Heart shape */}
      <div className="absolute bottom-[60%] left-[40%] w-6 h-6 bg-violet-600 animate-pulse opacity-20 z-0"
           style={{
