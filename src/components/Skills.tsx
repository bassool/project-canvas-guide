...
const Skills = () => {
  return <section id="skills" className="relative bg-slate-300">
      ...
      <div className="absolute top-[18%] right-[10%] w-2 h-2 rounded-full bg-black animate-pulse opacity-25" style={{
      animationDelay: "0.5s"
    }}></div>
      <div className="absolute top-[35%] left-[12%] w-4 h-4 rounded-full bg-black animate-float opacity-15" style={{
      animationDelay: "1s"
    }}></div>
      <div className="absolute top-[55%] right-[15%] w-3 h-3 rounded-full bg-black animate-pulse opacity-30" style={{
      animationDelay: "1.5s"
    }}></div>
      <div className="absolute bottom-[20%] left-[8%] w-2 h-2 rounded-full bg-black animate-float opacity-25" style={{
      animationDelay: "2s"
    }}></div>
      <div className="absolute bottom-[30%] right-[12%] w-5 h-5 rounded-full bg-black animate-pulse opacity-20" style={{
      animationDelay: "2.5s"
    }}></div>
      ...
      <div className="absolute top-[42%] right-[22%] w-4 h-4 rounded-full border border-black animate-spin-slow opacity-20" style={{
      animationDirection: "reverse"
    }}></div>
      <div className="absolute bottom-[25%] left-[22%] w-5 h-5 rounded-full border border-black animate-spin-slow opacity-30" style={{
      animationDelay: "1s"
    }}></div>
      <div className="absolute bottom-[45%] right-[28%] w-3 h-3 rounded-full border border-black animate-spin-slow opacity-25" style={{
      animationDirection: "reverse",
      animationDelay: "1.5s"
    }}></div>
      
      {/* Additional floating bubbles */}
      <div className="absolute top-[65%] left-[4%] w-2 h-2 rounded-full bg-black animate-pulse opacity-20" style={{
      animationDelay: "3s"
    }}></div>
      <div className="absolute top-[75%] right-[6%] w-3 h-3 rounded-full bg-black animate-float opacity-15" style={{
      animationDelay: "3.5s"
    }}></div>
      <div className="absolute top-[8%] left-[35%] w-2 h-2 rounded-full bg-black animate-pulse opacity-25" style={{
      animationDelay: "4s"
    }}></div>
      <div className="absolute bottom-[10%] right-[35%] w-4 h-4 rounded-full bg-black animate-float opacity-20" style={{
      animationDelay: "4.5s"
    }}></div>
      
      {/* Decorative pattern */}
      <div className="absolute top-20 left-10 grid grid-cols-3 gap-2 opacity-20 -z-10">
        {[...Array(9)].map((_, i) => <div key={i} className="w-4 h-4 rounded-full bg-black"></div>)}
      </div>
