...
const Skills = () => {
  return (
    <section id="skills" className="relative bg-amber-50">
      ...
      <div className="absolute top-[28%] right-[5%] w-5 h-8 bg-violet-600 animate-pulse opacity-5 z-0"
           style={{
      ...
      {/* Spinning gear */}
      <div className="absolute bottom-[55%] left-[2%] w-6 h-6 bg-violet-600 animate-spin-slow opacity-5 z-0"
           style={{
      ...
      {/* Floating triangle */}
      <div className="absolute top-[5%] right-[30%] w-0 h-0 animate-float opacity-5 z-0"
           style={{
      ...
      {/* Pulsing plus sign */}
      <div className="absolute bottom-[70%] left-[35%] animate-pulse opacity-5 z-0"
           style={{
             animationDelay: "4.1s"
           }}>
      ...
      <div className="absolute bottom-[15%] right-[20%] w-6 h-6 bg-violet-600 animate-float opacity-5 z-0" 
           style={{
      ...
      <div className="absolute top-[60%] right-[40%] w-7 h-7 bg-violet-600 animate-spin-slow opacity-5 z-0"
           style={{
      ...
      <div className="absolute top-[25%] left-[40%] w-6 h-6 bg-violet-600 animate-pulse opacity-5 transform rotate-45 z-0" 
           style={{
             animationDelay: "3.3s"
           }}></div>
      
      {/* Heart shape */}
      <div className="absolute bottom-[35%] right-[8%] w-6 h-6 bg-violet-600 animate-pulse opacity-5 z-0"
           style={{
