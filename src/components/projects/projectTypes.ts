...
export const projects: Project[] = [
  {
    ...
    galleryImages: [
      ...
      "/lovable-uploads/wild_2.png",
      "/lovable-uploads/wild_3.png",
      "/lovable-uploads/wild_4.png",
      "/lovable-uploads/wild_5.png",
      "/lovable-uploads/wild_6.png",
      "/lovable-uploads/wild_7.png",
      "/lovable-uploads/wildcard_8.png",
      "/lovable-uploads/wildcard_9.png",
      "/lovable-uploads/wildcard_10.jpg",
      "/lovable-uploads/wild_11.png"
    ],
    tools: ["Figma", "Notion", "Photoshop", "Slack", "Canva", "ChatGPT", "OpenAI", "Lovable", "Bolt", "Proprietary Company Software"],
    summary: "Managed 20+ concurrent campaigns in Notion, coordinating timelines, designing assets (Figma, Photoshop), and feedback cycles across cross-functional teams via Slack under the Operations Manager end-to-end.",
  ...
  },
  {
    ...
    solution: "Coordinated the transportation of merchandise cross-functionally for multiple events, also designed clean and innovative live pop up displays tailored specifically to each event, creating a curated and seamless experience that embodied the nomadic spirit of the brand."
  },
  {
    id: 5,
    title: "Zapshot",
  ...
  },
  {
    ...
    audioTracks: [
      { title: "Main Menu and Dialogue Theme", url: "/lovable-uploads/Main_Menu_and_Dialogue_Theme.mp3" },
      { title: "Battle Theme 1", url: "/lovable-uploads/Battle_Theme_1.mp3" },
      { title: "Battle Theme 2", url: "/lovable-uploads/Battle_Theme_2.mp3" }
    ]
  }
];
