...
const Skills = () => {
  return (
    <section id="skills" className="relative bg-stone-50">
      ...
      <div className="absolute top-[28%] right-[5%] w-5 h-8 bg-amber-800 animate-pulse !opacity-100 z-0" style={{
        clipPath: "polygon(20% 0%, 80% 0%, 60% 40%, 100% 40%, 40% 100%, 0% 60%, 40% 60%)",
        animationDelay: "2.3s"
      }}></div>
      
      {/* Spinning gear */}
      <div className="absolute bottom-[55%] left-[2%] w-6 h-6 bg-amber-800 animate-spin-slow !opacity-100 z-0" style={{
      ...
      <div className="absolute bottom-[15%] right-[20%] w-6 h-6 bg-amber-800 animate-float !opacity-100 z-0" style={{
      ...
      <div className="absolute top-[60%] right-[40%] w-7 h-7 bg-amber-800 animate-spin-slow !opacity-100 z-0" style={{
        clipPath: "polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)",
        animationDelay: "1.4s"
      }}></div>
      
      {/* Diamond near skills title */}
      <div className="absolute top-[25%] left-[40%] w-6 h-6 bg-amber-800 animate-pulse !opacity-100 transform rotate-45 z-0" style={{
        animationDelay: "3.3s"
      }}></div>
      
      {/* Heart shape */}
      <div className="absolute bottom-[35%] right-[8%] w-6 h-6 bg-amber-800 animate-pulse !opacity-100 z-0" style={{
