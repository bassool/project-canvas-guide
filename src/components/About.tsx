...
const About = () => {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-amber-50">
      ...
      <div className="absolute top-[25%] left-[35%] w-4 h-4 bg-violet-600 animate-spin-slow opacity-100 z-0" 
           style={{
             clipPath: "polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)",
             animationDelay: "1.2s"
           }}></div>
      
      {/* Pulsing plus sign near text - FIXED OPACITY */}
      <div className="absolute bottom-[50%] right-[35%] animate-pulse opacity-100 z-0" 
           style={{
             animationDelay: "2.8s"
           }}>
      ...
      <div className="absolute top-[65%] left-[25%] w-3 h-3 bg-violet-600 animate-float opacity-100 transform rotate-12 z-0" 
           style={{
             animationDelay: "4.2s"
           }}></div>
      ...
      {/* Star near image */}
      <div className="absolute top-[35%] right-[5%] w-7 h-7 bg-violet-600 animate-float opacity-100 z-0" 
           style={{
      ...
      {/* Triangle near stats */}
      <div className="absolute bottom-[35%] left-[40%] w-0 h-0 animate-float opacity-100 z-0" 
           style={{
      ...
      {/* Lightning bolt */}
      <div className="absolute top-[45%] left-[5%] w-5 h-8 bg-violet-600 animate-pulse opacity-100 z-0" 
           style={{
      ...
      {/* Diamond near button */}
      <div className="absolute bottom-[25%] right-[45%] w-6 h-6 bg-violet-600 animate-pulse opacity-100 transform rotate-45 z-0" 
           style={{
             animationDelay: "2.1s"
           }}></div>
